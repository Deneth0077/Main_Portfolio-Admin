...
export const addNewSkill = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://portfolio-main-lemon-gamma.vercel.app/api/v1/skill/add",
      data,
      {
        withCredentials: true,
...
export const updateSkill = (id, proficiency) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `https://portfolio-main-lemon-gamma.vercel.app/api/v1/skill/update/${id}`,
      { proficiency },
      {
        withCredentials: true,
...
export const deleteSkill = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://portfolio-main-lemon-gamma.vercel.app/api/v1/skill/delete/${id}`,
      {
        withCredentials: true,
      }
    );
